...
$OAuth = array("token" => utilities\Session::get("token"), "user_id" => utilities\Session::get("user_id"));
...
if($state === 0){
    ...
    $GLOBALS["office"] = utilities\Session::get("office");
    $GLOBALS["username"] = utilities\Session::get("username");
}
elseif($state === 1){
