<?php
//The Session Database Accessor class

namespace database;

class SessionAccess{
    //define class constants
    private $db_table = DB_PREFIX . "sessions";
    ...
    public function updateLastAccess($last_access){
        $db_handle = $this->sql_handler;
        $db_handle->addColumnValues("last_access",$last_access);
        $db_handle->addClause("id",$this->id);
        $db_handle->buildUpdate($this->db_table);
        $db_handle->execute();
    }
