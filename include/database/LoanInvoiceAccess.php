...
class LoanInvoiceAccess{
    //define class constants
    private $db_table = DB_PREFIX . "loan_invoice";
    ...
    public function update($obj){
        ...
        $db_handle->addColumnValues("amount_paid", $obj->get_amountPaid());
        $db_handle->addColumnValues("default_charge", $obj->get_defaultCharge());
        $db_handle->addColumnValues("roll_over", $obj->get_rollOver());
