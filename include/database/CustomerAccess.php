<?php
//The Customer Database Accessor class

namespace database;

class CustomerAccess{
    //define class constants
    private $db_table = DB_PREFIX . "customers";
    ...
    public function update($obj){
        $db_handle = $this->sql_handler;
        $db_handle->addColumnValues("category", $obj->get_category());
        $db_handle->addColumnValues("bio_data", $obj->get_bioData());
        $db_handle->addColumnValues("id_data", $obj->get_IdData());
        $db_handle->addColumnValues("crp_mode", $obj->get_crpMode());
        $db_handle->addColumnValues("employment_data", $obj->get_employmentData());
        $db_handle->addColumnValues("kin_data", $obj->get_kinData());
        $db_handle->addColumnValues("marketer", $obj->get_marketer());
