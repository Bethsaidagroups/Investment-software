...
class OfficeAccess{
    ...
    private $db_table = DB_PREFIX . "offices";
    ...
    //Update Offices details
    public function update($obj){
        $db_handle = $this->sql_handler;
        $db_handle->addColumnValues("location", $obj->get_location());
        $db_handle->addColumnValues("type", $obj->get_type());
        $db_handle->addColumnValues("description", $obj->get_description());
