<?php
//The Savings Account Database Accessor class

namespace database;

class SavingsAccountAccess{
    //define class constants
    private $db_table = DB_PREFIX . "savings_account";
    ...
    public function update($obj){
        $db_handle = $this->sql_handler;
        $db_handle->addColumnValues("plan", $obj->get_plan());
